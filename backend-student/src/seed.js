...
const seed = async () => {
  try {
    ...
    await pool.query(`
      ...
      VALUES
        ('student1@test.com', 'Алексеев Дмитрий Павлович', 'Базы данных', 8, 'lab', '2025-09-15', 'Хорошая работа'),
        ('student1@test.com', 'Алексеев Дмитрий Павлович', 'Базы данных', 9, 'test', '2025-10-01', 'Отлично'),
        ('student2@test.com', 'Белова Екатерина Андреевна', 'Базы данных', 7, 'lab', '2025-09-15', 'Хорошо'),
        ('student2@test.com', 'Белова Екатерина Андреевна', 'Базы данных', 8, 'test', '2025-10-01', 'Очень хорошо'),
        ('student3@test.com', 'Волков Артём Сергеевич', 'Базы данных', 5, 'lab', '2025-09-15', 'Удовлетворительно'),
        ('student4@test.com', 'Григорьева Анна Олеговна', 'Базы данных', 9, 'lab', '2025-09-15', 'Превосходно!'),
        ('student1@test.com', 'Алексеев Дмитрий Павлович', 'Программирование', 9, 'lab', '2025-09-20', 'Отлично'),
        ('student2@test.com', 'Белова Екатерина Андреевна', 'Программирование', 8, 'lab', '2025-09-20', 'Хорошо'),
        ('student3@test.com', 'Волков Артём Сергеевич', 'Программирование', 6, 'lab', '2025-09-20', 'Нужно доработать'),
        ('student1@test.com', 'Алексеев Дмитрий Павлович', 'Математический анализ', 8, 'quiz', '2025-09-25', 'Хорошо'),
        ('student2@test.com', 'Белова Екатерина Андреевна', 'Математический анализ', 9, 'quiz', '2025-09-25', 'Отлично'),
        ('student3@test.com', 'Волков Артём Сергеевич', 'Математический анализ', 3, 'quiz', '2025-09-25', 'Неудовлетворительно')
      ON CONFLICT DO NOTHING
    `);
    ...
    await pool.query(`
      ...
      VALUES
        ('Базы данных', 'ЛР 1: Проектирование реляционной БД', 'Спроектировать базу данных для интернет-магазина. Создать ER-диаграмму, нормализовать таблицы.', '2025-10-15', 'Иванова Мария Ивановна', 'ivanova@test.com', 10, false, 'Книга: "Базы данных" Коннолли, глава 1-4'),
        ('Базы данных', 'ЛР 2: SQL запросы', 'Написать SQL запросы для созданной БД: SELECT, JOIN, GROUP BY, подзапросы.', '2025-11-01', 'Иванова Мария Ивановна', 'ivanova@test.com', 10, false, 'Документация PostgreSQL: postgresql.org/docs'),
        ('Базы данных', 'ЛР 3: Транзакции и триггеры', 'Реализовать транзакции и триггеры для бизнес-логики интернет-магазина.', '2025-11-20', 'Иванова Мария Ивановна', 'ivanova@test.com', 10, true, 'Лекции 5-6, материалы на Moodle'),
        ('Программирование', 'ЛР 1: Основы Node.js', 'Создать REST API сервер на Node.js с Express. CRUD операции.', '2025-10-10', 'Петров Сергей Викторович', 'petrov@test.com', 10, false, 'Документация Express: expressjs.com'),
        ('Программирование', 'ЛР 2: React приложение', 'Разработать SPA на React с использованием хуков и контекста.', '2025-11-05', 'Петров Сергей Викторович', 'petrov@test.com', 10, false, 'Документация React: react.dev')
      ON CONFLICT DO NOTHING
    `);
    ...
    // === СДАЧИ ЛАБОРАТОРНЫХ ===
    await pool.query(`
      INSERT INTO lab_submissions (lab_work_id, student_email, student_name, team_name, solution_text, submitted_at, score, status)
      VALUES
        (1, 'student1@test.com', 'Алексеев Дмитрий Павлович', NULL, 'Выполнил проектирование БД для интернет-магазина. Создал ER-диаграмму с 8 таблицами.', '2025-10-14 14:30:00', 8, 'checked'),
        (1, 'student2@test.com', 'Белова Екатерина Андреевна', NULL, 'ER-диаграмма и нормализация до 3NF. Подробное описание связей.', '2025-10-15 10:00:00', 7, 'checked'),
        (1, 'student3@test.com', 'Волков Артём Сергеевич', NULL, 'Базовое проектирование, 6 таблиц.', '2025-10-16 09:00:00', 5, 'checked'),
        (1, 'student4@test.com', 'Григорьева Анна Олеговна', NULL, 'Полное проектирование с описанием всех ограничений и индексов.', '2025-10-13 16:00:00', 9, 'checked'),
        (2, 'student1@test.com', 'Алексеев Дмитрий Павлович', NULL, 'SQL скрипт с 15 запросами разной сложности.', '2025-10-30 11:00:00', NULL, 'submitted'),
        (2, 'student2@test.com', 'Белова Екатерина Андреевна', NULL, 'Все запросы реализованы, включая подзапросы.', '2025-11-01 08:00:00', NULL, 'submitted'),
        (3, 'student1@test.com', 'Алексеев Дмитрий Павлович', 'React Team Alpha', 'React SPA с хуками, контекстом, роутингом.', '2025-12-01 11:00:00', NULL, 'submitted'),
        (3, 'student2@test.com', 'Белова Екатерина Андреевна', 'React Team Alpha', 'React приложение с компонентами и состоянием.', '2025-12-01 08:00:00', NULL, 'submitted'),
        (3, 'student4@test.com', 'Григорьева Анна Олеговна', 'React Team Beta', 'React приложение с анимациями и переходами.', '2025-12-01 14:00:00', NULL, 'submitted'),
        (3, 'student6@test.com', 'Егорова Полина Владимировна', 'React Team Beta', 'SPA с роутингом и API.', '2025-12-01 09:00:00', NULL, 'submitted'),
        (7, 'student1@test.com', 'Алексеев Дмитрий Павлович', 'DB Team Alpha', 'ER-диаграмма для интернет-магазина, 8 сущностей, нормализация до 3НФ.', '2025-11-01 11:00:00', NULL, 'submitted'),
        (7, 'student4@test.com', 'Григорьева Дарья Олеговна', 'DB Team Alpha', 'Полное проектирование БД с описанием ограничений.', '2025-11-01 14:00:00', NULL, 'submitted'),
        (7, 'student2@test.com', 'Белова Екатерина Андреевна', 'DB Team Beta', 'Все запросы реализованы, включая подзапросы и представления.', '2025-11-01 08:00:00', NULL, 'submitted'),
        (7, 'student6@test.com', 'Егорова Полина Владимировна', 'DB Team Beta', 'SQL скрипт с JOIN и GROUP BY.', '2025-11-01 09:00:00', NULL, 'submitted')
      ON CONFLICT DO NOTHING
    `);
