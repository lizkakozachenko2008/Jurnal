                ...
                <tr key={grade.id} className="hover:bg-slate-50/50 transition-colors">
                  ...
                  <td className="px-5 py-3.5">
                    <div className="w-24 bg-slate-100 rounded-full h-2">
                      <div
                        className={`h-2 rounded-full ${grade.grade >= 90 ? 'bg-emerald-500' : grade.grade >= 75 ? 'bg-blue-500' : grade.grade >= 60 ? 'bg-amber-500' : 'bg-red-500'}`}
                        style={{ width: `${Math.min(grade.grade, 100)}%` }}
                      />
                    </div>
                  </td>
                </tr>
