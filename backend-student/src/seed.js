...
const seed = async () => {
  try {
    ...
    await pool.query(`
      ...
      VALUES
        (1, 'student1@test.com', 'Алексеев Дмитрий Павлович', 'Выполнил проектирование БД для интернет-магазина. Создал ER-диаграмму с 8 таблицами.', '2025-10-14 14:30:00', 8, 'checked'),
        (1, 'student2@test.com', 'Белова Екатерина Андреевна', 'ER-диаграмма и нормализация до 3NF. Подробное описание связей.', '2025-10-15 10:00:00', 7, 'checked'),
        (1, 'student3@test.com', 'Волков Артём Сергеевич', 'Базовое проектирование, 6 таблиц.', '2025-10-16 09:00:00', 5, 'checked'),
        (1, 'student4@test.com', 'Григорьева Анна Олеговна', 'Полное проектирование с описанием всех ограничений и индексов.', '2025-10-13 16:00:00', 9, 'checked'),
        ...
        (4, 'student1@test.com', 'Алексеев Дмитрий Павлович', 'REST API с 5 эндпоинтами, валидация данных.', '2025-10-09 15:00:00', 9, 'checked'),
        (4, 'student2@test.com', 'Белова Екатерина Андреевна', 'API сервер с middleware и обработкой ошибок.', '2025-10-10 12:00:00', 8, 'checked')
      ON CONFLICT DO NOTHING
    `);
